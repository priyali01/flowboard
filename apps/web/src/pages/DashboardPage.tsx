...
export const DashboardPage = () => {
 ...
 className="flex items-center px-4 py-2 bg-white border text-gray-700 rounded-md shadow-sm hover:bg-gray-50 :bg-gray-750"
 >
 ...
 <p className="mt-2 text-3xl font-bold text-gray-900 ">{data.totalTasks}</p>
 </div>
 <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 ">
 <div className="flex items-center justify-between">
 ...
 <p className="mt-2 text-3xl font-bold text-gray-900 ">{data.completedTasks}</p>
 </div>
 <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 ">
 <div className="flex items-center justify-between">
 ...
 <p className="mt-2 text-3xl font-bold text-gray-900 ">{data.overdueTasks}</p>
 </div>
 <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 ">
 <div className="flex items-center justify-between">
 ...
 <p className="mt-2 text-3xl font-bold text-gray-900 ">{data.currentStreak} days</p>
 </div>
 </div>
 ...
 <h3 className="text-lg font-medium text-gray-900 mb-6">Completed Tasks (Last 30 Days)</h3>

          ...
          comments?.map(comment => (
            <div key={comment.id} className="flex space-x-3">
              <div className="flex-shrink-0 mt-1">
                <div className="h-8 w-8 rounded-full bg-primary-100 dark:bg-primary-900/40 flex items-center justify-center text-primary-700 dark:text-primary-300 font-bold text-sm shadow-sm ring-1 ring-primary-500/20">
              ...
              <div className="flex-1 bg-[var(--bg-subtle)] border border-[var(--border-default)] rounded-lg p-3 relative group shadow-sm">
                ...
                <div className="prose prose-sm dark:prose-invert text-[var(--text-secondary)] max-w-none" dangerouslySetInnerHTML={{ __html: comment.content }} />

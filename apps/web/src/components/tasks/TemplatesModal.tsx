...
export const TemplatesModal: React.FC<Props> = ({ onClose }) => {
 ...
 className="p-2 text-primary-600 hover:bg-primary-50 :bg-primary-900/20 rounded-md disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
 ...
 className="p-2 text-red-600 hover:bg-red-50 :bg-red-900/20 rounded-md transition-colors"

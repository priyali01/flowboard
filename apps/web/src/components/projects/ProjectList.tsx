                ...
                <DropdownMenu.Portal>
                  ...
                  >
                    ...
                    <DropdownMenu.Item 
                      ...
                      className="flex items-center px-2 py-1.5 text-sm outline-none cursor-pointer rounded-md text-red-600 hover:bg-red-50 focus:bg-red-50 dark:hover:bg-red-900/20 dark:focus:bg-red-900/20"
                    >

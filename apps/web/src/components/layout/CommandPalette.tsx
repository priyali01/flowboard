          ...
          <Command.List className="p-2 overflow-y-auto">
            ...
            <Command.Group heading="Actions" className="px-2 py-1 mt-3 text-xs font-semibold text-[var(--text-secondary)] uppercase tracking-wider">
              ...
              <Command.Item 
                ...
                className="flex items-center px-2 py-2 rounded-md text-sm font-medium text-red-600 cursor-pointer hover:bg-red-50 focus:bg-red-50 dark:hover:bg-red-900/20 dark:focus:bg-red-900/20 aria-selected:bg-red-50 dark:aria-selected:bg-red-900/20"
              >

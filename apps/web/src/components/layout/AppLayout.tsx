...
import {
  ...
  BarChart2, MessageSquare, Settings, Plus, Bell, Search,
  Tag, LayoutTemplate, Crown, LogOut
} from 'lucide-react';
    ...
    >
      ...
      <aside className="w-[240px] flex-shrink-0 bg-white/60 backdrop-blur-xl border-r border-white/50 flex flex-col z-20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
        ...
        <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
          ...
          <div className="pt-4 border-t border-white/50 mt-4 space-y-1">
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-semibold text-gray-500 hover:bg-white/60 hover:text-gray-800 transition-all"
            >
        ...
        <div className="px-4 pb-3">
          <div className="bg-white/80 backdrop-blur-md border border-white rounded-2xl p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-1.5">
              <div className="w-6 h-6 rounded-lg bg-yellow-400 flex items-center justify-center shadow-inner">
                <Crown size={12} className="text-white" />
              </div>
              <span className="text-sm font-bold text-gray-800">Upgrade to Pro</span>
            </div>
            <p className="text-xs text-gray-500 mb-3 leading-relaxed">Unlock more features and boost productivity.</p>
            <button className="w-full flex items-center justify-between px-3 py-2 bg-[var(--bg-app)] hover:bg-gray-100 rounded-xl text-xs font-bold text-primary-600 shadow-sm transition-all">
              Get Pro <span className="text-gray-400">›</span>
            </button>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden bg-white/40 backdrop-blur-xl">
        ...
        <header className="h-16 flex items-center justify-between px-8 bg-transparent border-b border-white/50 z-10 flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Let's make today productive!</p>
          </div>

          {/* Center: Search */}
          <div className="flex-1 max-w-sm mx-8">
            <button className="w-full flex items-center gap-2 px-4 py-2 bg-[var(--bg-app)] dark:bg-gray-800 border border-[var(--border-default)] rounded-xl text-sm text-gray-400 hover:border-primary-300 transition-all">
